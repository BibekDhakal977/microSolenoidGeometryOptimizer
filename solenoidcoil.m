classdef solenoidcoil
    % solenoidcoilobj Class
    %
    % Description:
    ...
    %
    % Methods:
    %   solenoidcoilMODobj: Constructor to initialize the class object.
...
% who wrote the initial version of this code.
    ...
    methods
        % Permeability of free space, resistivity, relative permeability, frequency
        function self = solenoidcoil(n, dcoil, lcoil, dwire,leadwirelength, f, rho, alpha, beta, sigma, tc, ts)
           % Assign input parameters to object properties
            ...
            self.Rcap = self.calculateCapacitance();
        ...
        %Enhancement factor calculaiton
        ...
        %calculate Rcap
        function Rcap = calculateCapacitance(self)
        ...
        function [Rnmr, RnmrTemp, SNR, SNRtemp] = calculateSNR(self)
            ...
            Rnmr = (self.Rcoil+ self.Rleads+ self.Rcap + self.RsampleDielectric); %conductive sample
